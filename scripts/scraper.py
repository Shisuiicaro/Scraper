...
MAX_GAMES = 1000000
CONCURRENT_REQUESTS = 300  # Reduzido para evitar bloqueios
CATEGORY_SEMAPHORE_LIMIT = 1
PAGE_SEMAPHORE_LIMIT = 15  # Reduzido para evitar muitas requisições simultâneas
GAME_SEMAPHORE_LIMIT = 80  # Reduzido para evitar muitas requisições simultâneas
